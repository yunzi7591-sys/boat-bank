...
export default async function MarketPage() {
    ...
    return (
        <div className="min-h-full pb-20">
            <div className="bg-white border-b border-slate-100 px-4 pt-5 pb-2 sticky top-[56px] z-40">
                <h1 className="text-xl font-bold text-slate-900 mb-4">マーケット</h1>

                <Tabs defaultValue="all" className="w-full">
                    <TabsList className="w-full h-10 bg-slate-100/80 p-1 rounded-xl">
                        <TabsTrigger
                            value="all"
                            className="w-full data-[state=active]:bg-white data-[state=active]:text-slate-900 data-[state=active]:shadow-sm rounded-lg font-semibold text-sm text-slate-500"
                        >
                    ...
                    <div className="mt-4">
                        ...
                        <TabsContent value="following" className="m-0 focus-visible:outline-none focus-visible:ring-0">
                            {!userId ? (
                                <div className="py-16 text-center text-slate-400">ログインしてフォロー機能を利用する</div>
                            ) : followingPredictions.length === 0 ? (
                                <div className="py-16 text-center text-slate-400">
                                    <p className="font-semibold text-slate-600 mb-1">フィードが空です</p>
